...
% sparse grids. The code adapts the original Krusell-Smith algorithm
% to neural networks and produces a Den Haan (2010) metric of 0.06%.
% 
...
%  Final print after 80 KS iterations
%     Den Haan (2010) metric for KS algorithm (max): 0.060396 
%     Den Haan (2010) metric for KS algorithm (avg): 0.013319 
% 
%------------------------------------------------------------------------%
