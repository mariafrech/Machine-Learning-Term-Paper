...
% model using adaptive sparse grids. The code uses the original 
% Krusell-Smith algorithm and produces a Den Haan (2010) metric of 0.15%.
% 
...
%  Final print after 64 KS iterations
%     Den Haan (2010) metric for KS algorithm (max): 0.148492
%     Den Haan (2010) metric for KS algorithm (avg): 0.023208
% 
%------------------------------------------------------------------------%
